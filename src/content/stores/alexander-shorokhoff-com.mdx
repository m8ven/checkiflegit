...
signals:
  ...
  domainAge:
    status: pass
    value:
      createdAt: '2003-03-13'
      ageDays: 8504
      ageYears: 23.3
    detail: Registered 23.3 years ago (2003-03-13).
  contact:
    status: warn
    value:
      email: false
...
A few checks were inconclusive when we looked, so they count neither for nor against Alexander-shorokhoff in the score above.
