...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "pctronic.com.py" not supported'
  contact:
    status: warn
    value:
      email: false
