...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 2891
      ageYears: 7.9
    detail: Registered 7.9 years ago (2018-07-26).
  contact:
    status: pass
    value:
      email: true
...
A few checks were inconclusive when we looked, so they count neither for nor against Thesilencio in the score above.
