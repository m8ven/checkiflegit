...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "qfix.com.bd" not supported'
  contact:
    status: warn
    value:
      email: false
