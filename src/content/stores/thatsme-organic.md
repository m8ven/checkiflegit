...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "thatsme.organic" not supported'
  contact:
    status: fail
    value:
      email: false
