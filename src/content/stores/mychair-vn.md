...
domain: mychair.vn
slug: mychair-vn
title: Is mychair.vn Legit? Trust Signal Check
description: >-
  An automated trust-signal check for mychair.vn: moderate trust signals. Domain
...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "mychair.vn" not supported'
  contact:
    status: pass
    value:
      email: true
