...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 1858
      ageYears: 5.1
    detail: Registered 5.1 years ago (2021-05-24).
  contact:
    status: pass
    value:
      email: true
...
A few checks were inconclusive when we looked, so they count neither for nor against Bm-rentacar in the score above.
