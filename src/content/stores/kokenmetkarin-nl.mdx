...
signals:
  ...
  domainAge:
    status: pass
    value:
      createdAt: '2005-02-08'
      ageDays: 7807
      ageYears: 21.4
    detail: Registered 21.4 years ago (2005-02-08).
  contact:
    status: warn
    value:
      email: true
...
A few checks were inconclusive when we looked, so they count neither for nor against Kokenmetkarin in the score above.
