...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 8175
      ageYears: 22.4
    detail: Registered 22.4 years ago (2004-02-06).
  contact:
    status: pass
    value:
      email: true
...
emeraldvalleyequine.com looks like a well-established store. The clearest positives are that its domain has been registered for 22.4 years and it lists genuine business contact details. On balance the public signals here are reassuring — shop with the same common-sense caution you would use anywhere online.

A few checks were inconclusive when we looked, so they count neither for nor against Emeraldvalleyequine in the score above.
