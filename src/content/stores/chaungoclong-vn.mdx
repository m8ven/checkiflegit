...
title: Is chaungoclong.vn Legit? Trust Signal Check
description: >-
  An automated trust-signal check for chaungoclong.vn: moderate trust signals.
...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "chaungoclong.vn" not supported'
  contact:
    status: warn
    value:
      email: false
