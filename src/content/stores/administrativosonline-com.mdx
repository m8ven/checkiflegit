...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 1552
      ageYears: 4.3
    detail: Registered 4.3 years ago (2022-03-26).
  contact:
    status: pass
    value:
      email: true
...
administrativosonline.com looks like a well-established store. The clearest positives are that its domain has been registered for 4.3 years and it lists genuine business contact details. On balance the public signals here are reassuring — shop with the same common-sense caution you would use anywhere online.

A few checks were inconclusive when we looked, so they count neither for nor against Administrativosonline in the score above.
