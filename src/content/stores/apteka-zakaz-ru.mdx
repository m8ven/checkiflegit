...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 1985
      ageYears: 5.4
    detail: Registered 5.4 years ago (2021-01-16).
  contact:
    status: warn
    value:
      email: false
...
apteka-zakaz.ru sends a mixed set of signals. On the positive side, its domain has been registered for 5.4 years and it secures traffic with a valid HTTPS certificate. Against that, only limited contact details are listed and some standard contact or policy pages appear to be missing — worth weighing before you buy. It is not a clear red flag, but we would treat a first purchase with measured caution and use a payment method that offers buyer protection.

A few checks were inconclusive when we looked, so they count neither for nor against Apteka-zakaz in the score above.
