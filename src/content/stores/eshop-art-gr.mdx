...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "eshop-art.gr" not supported'
  contact:
    status: pass
    value:
      email: true
