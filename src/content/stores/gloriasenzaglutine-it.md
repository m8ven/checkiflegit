...
fetchedAt: '2026-08-03T08:36:45.045Z'
...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 2350
      ageYears: 6.4
    detail: Registered 6.4 years ago (2020-02-25).
  contact:
    status: warn
    value:
      email: false
...
gloriasenzaglutine.it looks like a well-established store. The clearest positives are that its domain has been registered for 6.4 years and it publishes the contact and policy pages shoppers expect. The main thing we would flag is that only limited contact details are listed, though it does not outweigh the positives. On balance the public signals here are reassuring — shop with the same common-sense caution you would use anywhere online.

A few checks were inconclusive when we looked, so they count neither for nor against Gloriasenzaglutine in the score above.
