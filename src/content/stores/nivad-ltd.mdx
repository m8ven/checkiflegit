...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "nivad.ltd" not supported'
  contact:
    status: warn
    value:
      email: false
