...
fetchedAt: '2026-07-27T08:26:36.171Z'
...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "jewelryshop.gr" not supported'
  contact:
    status: pass
    value:
      email: true
...
A few checks were inconclusive when we looked, so they count neither for nor against Jewelryshop in the score above.
