...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 5908
      ageYears: 16.2
    detail: Registered 16.2 years ago (2010-04-21).
  contact:
    status: pass
    value:
      email: true
...
A few checks were inconclusive when we looked, so they count neither for nor against Isabellenails in the score above.
