...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 1786
      ageYears: 4.9
    detail: Registered 4.9 years ago (2021-08-04).
  contact:
    status: warn
    value:
      email: false
...
A few checks were inconclusive when we looked, so they count neither for nor against Regionals in the score above.
