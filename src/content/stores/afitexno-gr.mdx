...
domain: afitexno.gr
slug: afitexno-gr
title: Is afitexno.gr Legit? Trust Signal Check
description: >-
  An automated trust-signal check for afitexno.gr: moderate trust signals.
...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "afitexno.gr" not supported'
  contact:
    status: warn
    value:
      email: false
...
A few checks were inconclusive when we looked, so they count neither for nor against Afitexno in the score above.
