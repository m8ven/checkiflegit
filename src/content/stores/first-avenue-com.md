...
fetchedAt: '2026-08-03T08:30:48.131Z'
...
signals:
  ...
  domainAge:
    status: pass
    value:
      createdAt: '1997-02-13'
      ageDays: 10763
      ageYears: 29.5
    detail: Registered 29.5 years ago (1997-02-13).
  contact:
    status: warn
    value:
      email: false
...
first-avenue.com looks like a well-established store. The clearest positives are that its domain has been registered for 29.5 years and it secures traffic with a valid HTTPS certificate. The main thing we would flag is that only limited contact details are listed and some standard contact or policy pages appear to be missing, though it does not outweigh the positives. On balance the public signals here are reassuring — shop with the same common-sense caution you would use anywhere online.

A few checks were inconclusive when we looked, so they count neither for nor against First-avenue in the score above.
