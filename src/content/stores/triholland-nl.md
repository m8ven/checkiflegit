...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 3371
      ageYears: 9.2
    detail: Registered 9.2 years ago (2017-04-02).
  contact:
    status: warn
    value:
      email: true
...
A few checks were inconclusive when we looked, so they count neither for nor against Triholland in the score above.
