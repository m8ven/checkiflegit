...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "grosser.wine" not supported'
  contact:
    status: fail
    value:
      email: false
