...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "hukata.vn" not supported'
  contact:
    status: warn
    value:
      email: false
