...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "pec.vn" not supported'
  contact:
    status: pass
    value:
      email: true
