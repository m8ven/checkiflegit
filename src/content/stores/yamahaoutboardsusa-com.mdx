...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 360
      ageYears: 1
    detail: Registered 1 years ago (2025-06-29).
  contact:
    status: pass
    value:
      email: true
...
A few checks were inconclusive when we looked, so they count neither for nor against Yamahaoutboardsusa in the score above.
