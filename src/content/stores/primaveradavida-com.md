...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 2220
      ageYears: 6.1
    detail: Registered 6.1 years ago (2020-05-26).
  contact:
    status: fail
    value:
      email: false
...
A few checks were inconclusive when we looked, so they count neither for nor against Primaveradavida in the score above.
