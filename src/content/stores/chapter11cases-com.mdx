...
signals:
  ...
  domainAge:
    status: pass
    value:
      createdAt: '2010-10-23'
      ageDays: 5724
      ageYears: 15.7
    detail: Registered 15.7 years ago (2010-10-23).
  contact:
    status: fail
    value:
      email: false
...
A few checks were inconclusive when we looked, so they count neither for nor against Chapter11cases in the score above.
