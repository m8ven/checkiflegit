...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 5075
      ageYears: 13.9
    detail: Registered 13.9 years ago (2012-08-01).
  contact:
    status: pass
    value:
      email: true
...
A few checks were inconclusive when we looked, so they count neither for nor against Centroculturaledimilano in the score above.
