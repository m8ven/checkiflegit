...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 665
      ageYears: 1.8
    detail: Registered 1.8 years ago (2024-08-29).
  contact:
    status: warn
    value:
      email: false
...
A few checks were inconclusive when we looked, so they count neither for nor against Hjertehalskaede in the score above.
