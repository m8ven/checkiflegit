...
slug: starcopier-vn
title: Is starcopier.vn Legit? Trust Signal Check
description: >-
  An automated trust-signal check for starcopier.vn: moderate trust signals.
...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "starcopier.vn" not supported'
  contact:
    status: pass
    value:
      email: true
