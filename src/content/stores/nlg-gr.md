...
domain: nlg.gr
slug: nlg-gr
title: Is nlg.gr Legit? Trust Signal Check
description: >-
  An automated trust-signal check for nlg.gr: moderate trust signals. Domain
...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "nlg.gr" not supported'
  contact:
    status: warn
    value:
      email: false
...
A few checks were inconclusive when we looked, so they count neither for nor against Nlg in the score above.
