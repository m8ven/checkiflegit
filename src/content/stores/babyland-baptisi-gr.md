...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "babyland-baptisi.gr" not supported'
  contact:
    status: pass
    value:
      email: true
