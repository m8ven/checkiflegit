...
domain: iwrite.gr
slug: iwrite-gr
title: Is iwrite.gr Legit? Trust Signal Check
description: >-
  An automated trust-signal check for iwrite.gr: moderate trust signals. Domain
...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "iwrite.gr" not supported'
  contact:
    status: warn
    value:
      email: false
...
A few checks were inconclusive when we looked, so they count neither for nor against Iwrite in the score above.
