...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 5980
      ageYears: 16.4
    detail: Registered 16.4 years ago (2010-02-09).
  contact:
    status: pass
    value:
      email: true
...
A few checks were inconclusive when we looked, so they count neither for nor against Cambuurculture in the score above.
