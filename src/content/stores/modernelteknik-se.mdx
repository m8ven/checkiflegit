...
signals:
  ...
  domainAge:
    status: pass
    value:
      createdAt: '2003-04-25'
      ageDays: 8462
      ageYears: 23.2
    detail: Registered 23.2 years ago (2003-04-25).
  contact:
    status: pass
    value:
      email: true
...
A few checks were inconclusive when we looked, so they count neither for nor against Modernelteknik in the score above.
