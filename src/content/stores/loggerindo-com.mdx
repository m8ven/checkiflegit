...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 6140
      ageYears: 16.8
    detail: Registered 16.8 years ago (2009-09-01).
  contact:
    status: pass
    value:
      email: true
...
A few checks were inconclusive when we looked, so they count neither for nor against Loggerindo in the score above.
