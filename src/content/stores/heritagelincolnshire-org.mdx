...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 6628
      ageYears: 18.2
    detail: Registered 18.2 years ago (2008-05-02).
  contact:
    status: pass
    value:
      email: true
...
heritagelincolnshire.org looks like a well-established store. The clearest positives are that its domain has been registered for 18.2 years and it lists genuine business contact details. On balance the public signals here are reassuring — shop with the same common-sense caution you would use anywhere online.

A few checks were inconclusive when we looked, so they count neither for nor against Heritagelincolnshire in the score above.
