...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "bikeis.life" not supported'
  contact:
    status: warn
    value:
      email: false
