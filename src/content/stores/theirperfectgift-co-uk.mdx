...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 4593
      ageYears: 12.6
    detail: Registered 12.6 years ago (2013-11-27).
  contact:
    status: warn
    value:
      email: false
...
theirperfectgift.co.uk looks like a well-established store. The clearest positives are that its domain has been registered for 12.6 years and it publishes the contact and policy pages shoppers expect. The main thing we would flag is that only limited contact details are listed, though it does not outweigh the positives. On balance the public signals here are reassuring — shop with the same common-sense caution you would use anywhere online.

A few checks were inconclusive when we looked, so they count neither for nor against Theirperfectgift in the score above.
