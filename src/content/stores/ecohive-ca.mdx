...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 3436
      ageYears: 9.4
    detail: Registered 9.4 years ago (2017-01-27).
  contact:
    status: pass
    value:
      email: true
