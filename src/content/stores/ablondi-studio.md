...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "ablondi.studio" not supported'
  contact:
    status: fail
    value:
      email: false
