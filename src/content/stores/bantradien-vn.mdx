...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "bantradien.vn" not supported'
  contact:
    status: pass
    value:
      email: true
...
A few checks were inconclusive when we looked, so they count neither for nor against Bantradien in the score above.
