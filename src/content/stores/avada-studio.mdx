...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "avada.studio" not supported'
  contact:
    status: fail
    value:
      email: false
