...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 1869
      ageYears: 5.1
    detail: Registered 5.1 years ago (2021-05-12).
  contact:
    status: warn
    value:
      email: false
...
A few checks were inconclusive when we looked, so they count neither for nor against Autoricambidoc in the score above.
