...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "migratorybirds.gr" not supported'
  contact:
    status: warn
    value:
      email: false
