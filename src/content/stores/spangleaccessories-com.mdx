...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 2459
      ageYears: 6.7
    detail: Registered 6.7 years ago (2019-10-01).
  contact:
    status: pass
    value:
      email: true
...
A few checks were inconclusive when we looked, so they count neither for nor against Spangleaccessories in the score above.
