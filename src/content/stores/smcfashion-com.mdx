...
signals:
  ...
  domainAge:
    status: pass
    value:
      createdAt: '2006-04-20'
      ageDays: 7370
      ageYears: 20.2
    detail: Registered 20.2 years ago (2006-04-20).
  contact:
    status: warn
    value:
      email: false
...
A few checks were inconclusive when we looked, so they count neither for nor against Smcfashion in the score above.
