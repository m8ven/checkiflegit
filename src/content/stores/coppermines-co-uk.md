...
signals:
  ...
  domainAge:
    status: pass
    value:
      createdAt: '1999-03-22'
      ageDays: 9957
      ageYears: 27.3
    detail: Registered 27.3 years ago (1999-03-22).
  contact:
    status: warn
    value:
      email: false
...
coppermines.co.uk looks like a well-established store. The clearest positives are that its domain has been registered for 27.3 years and it publishes the contact and policy pages shoppers expect. The main thing we would flag is that only limited contact details are listed, though it does not outweigh the positives. On balance the public signals here are reassuring — shop with the same common-sense caution you would use anywhere online.

A few checks were inconclusive when we looked, so they count neither for nor against Coppermines in the score above.
