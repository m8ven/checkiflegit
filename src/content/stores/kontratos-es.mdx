...
domain: kontratos.es
slug: kontratos-es
title: Is kontratos.es Legit? Trust Signal Check
description: >-
  An automated trust-signal check for kontratos.es: strong trust signals. Domain
  age, SSL, contact info, reviews and more.
fetchedAt: '2026-06-25T02:42:45.695Z'
finalUrl: 'https://kontratos.es/'
reachable: true
noindex: false
verdict:
  tier: strong
...
A few checks were inconclusive when we looked, so they count neither for nor against Kontratos in the score above.
