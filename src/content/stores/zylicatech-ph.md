...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "zylicatech.ph" not supported'
  contact:
    status: warn
    value:
      email: false
