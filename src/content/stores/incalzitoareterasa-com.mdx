...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 3087
      ageYears: 8.5
    detail: Registered 8.5 years ago (2018-01-11).
  contact:
    status: warn
    value:
      email: false
...
A few checks were inconclusive when we looked, so they count neither for nor against Incalzitoareterasa in the score above.
