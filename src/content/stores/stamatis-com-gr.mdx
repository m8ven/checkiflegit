...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "stamatis.com.gr" not supported'
  contact:
    status: pass
    value:
      email: true
