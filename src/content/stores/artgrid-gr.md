...
fetchedAt: '2026-07-27T08:14:46.289Z'
...
signals:
  ...
  domainAge:
    status: unknown
    value: null
    detail: 'WHOIS lookup failed: TLD for "artgrid.gr" not supported'
  contact:
    status: fail
    value:
      email: false
...
A few checks were inconclusive when we looked, so they count neither for nor against Artgrid in the score above.
