...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 2523
      ageYears: 6.9
    detail: Registered 6.9 years ago (2019-07-29).
  contact:
    status: fail
    value:
      email: false
...
A few checks were inconclusive when we looked, so they count neither for nor against Weboating in the score above.
