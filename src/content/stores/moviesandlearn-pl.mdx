...
description: >-
  An automated trust-signal check for moviesandlearn.pl: strong trust signals.
  Domain age, SSL, contact info, reviews and more.
fetchedAt: '2026-06-25T01:42:58.086Z'
...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 1660
      ageYears: 4.5
    detail: Registered 4.5 years ago (2021-12-07).
  contact:
    status: pass
    value:
      email: true
