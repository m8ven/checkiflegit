...
signals:
  ...
  domainAge:
    status: pass
    value:
      createdAt: '2013-05-30'
      ageDays: 4773
      ageYears: 13.1
    detail: Registered 13.1 years ago (2013-05-30).
  contact:
    status: fail
    value:
      email: false
...
bitajarod.com sends a mixed set of signals. On the positive side, its domain has been registered for 13.1 years and it secures traffic with a valid HTTPS certificate. Against that, there are no clear public contact details and some standard contact or policy pages appear to be missing — worth weighing before you buy. It is not a clear red flag, but we would treat a first purchase with measured caution and use a payment method that offers buyer protection.

A few checks were inconclusive when we looked, so they count neither for nor against Bitajarod in the score above.
