...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 3245
      ageYears: 8.9
    detail: Registered 8.9 years ago (2017-08-05).
  contact:
    status: fail
    value:
      email: false
...
typewronger.com sends a mixed set of signals. On the positive side, its domain has been registered for 8.9 years and it secures traffic with a valid HTTPS certificate. Against that, there are no clear public contact details and some standard contact or policy pages appear to be missing — worth weighing before you buy. It is not a clear red flag, but we would treat a first purchase with measured caution and use a payment method that offers buyer protection.

A few checks were inconclusive when we looked, so they count neither for nor against Typewronger in the score above.
