...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 2408
      ageYears: 6.6
    detail: Registered 6.6 years ago (2019-11-20).
  contact:
    status: pass
    value:
      email: true
...
A few checks were inconclusive when we looked, so they count neither for nor against Iltuogioiello in the score above.
