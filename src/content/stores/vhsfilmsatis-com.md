...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 3418
      ageYears: 9.4
    detail: Registered 9.4 years ago (2017-02-13).
  contact:
    status: warn
    value:
      email: false
...
vhsfilmsatis.com sends a mixed set of signals. On the positive side, its domain has been registered for 9.4 years and it secures traffic with a valid HTTPS certificate. Against that, only limited contact details are listed and some standard contact or policy pages appear to be missing — worth weighing before you buy. It is not a clear red flag, but we would treat a first purchase with measured caution and use a payment method that offers buyer protection.

A few checks were inconclusive when we looked, so they count neither for nor against Vhsfilmsatis in the score above.
