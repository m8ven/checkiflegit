...
fetchedAt: '2026-08-10T06:21:14.242Z'
...
signals:
  ...
  domainAge:
    ...
    value:
      ...
      ageDays: 3975
      ageYears: 10.9
    detail: Registered 10.9 years ago (2015-09-21).
  contact:
    status: fail
    value:
      email: false
...
starmelee.com looks like a well-established store. The clearest positives are that its domain has been registered for 10.9 years and it publishes the contact and policy pages shoppers expect. The main thing we would flag is that there are no clear public contact details, though it does not outweigh the positives. On balance the public signals here are reassuring — shop with the same common-sense caution you would use anywhere online.

A few checks were inconclusive when we looked, so they count neither for nor against Starmelee in the score above.
